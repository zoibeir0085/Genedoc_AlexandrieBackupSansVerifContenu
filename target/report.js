$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:/C:/Users/abensalah/.jenkins/workspace/Genedoc_AlexandrieBackupSansVerifContenu/src/test/java/Features/ScenarioAlexandrie.feature");
formatter.feature({
...
formatter.step({
  "name": "I enter the engagement code : \"2110678\"",
  "keyword": "Then "
});
formatter.match({
